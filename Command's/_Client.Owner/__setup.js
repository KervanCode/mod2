...
if(args[0] === "public" || args[0] === "publickategori") {
    let select = args[1];
    if (!select) return message.react(client.emojis.cache.find(res => res.name === "red"));
    ...
    if(args[0] === "banlog" || args[0] === "banbilgi") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Ban Log\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "cpuanlog" || args[0] === "cezapuanlog") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Cezapuan Log\` kanalı ${channel} olarak ayarlandı!`)}    
    if(args[0] === "vmutelog" || args[0] === "vmutebilgi") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Voice-Mute Log\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "meeting" || args[0] === "toplantı") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Toplantı\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "cmutelog" || args[0] === "cmutebilgi") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Chat-Mute Log\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "jaillog" || args[0] === "jailbilgi") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Jail Log\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "guardlog" || args[0] === "guardbilgi") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Guard Log\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "rolalma" || args[0] === "rol-alma") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Rol-Alma\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "basvurulog" || args[0] === "başvurulog") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Başvuru-Log\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "başvurukanal" || args[0] === "başvuruchannel") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Başvuru-Kanal\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "BotSes" || args[0] === "botses") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Bot Ses\` kanalı ${channel} olarak ayarlandı!`)}
    ...
    if(args[0] === "taglog" || args[0] === "tag-log") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Tag-Log\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "yttaglog" || args[0] === "yttag-log") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Yetki-Tag-Log\` kanalı ${channel} olarak ayarlandı!`)}
    ...
    if(args[0] === "rolsecim" || args[0] === "rolseçim") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Rol-Seçim\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "kpanel" || args[0] === "kullanıcıpanel") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Kullanıcı-Panel\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "kurallar" || args[0] === "rules") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Kurallar\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "komutkanalar" || args[0] === "commandchannel" || args[0] === "komutkanal") { let Roles;
       ...
       await _setup.findOneAndUpdate({ guildID: client.guilds.cache.get(Settings.guildID) }, { $set: { komutChannels: channels } }, { upsert: true }).exec();
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Genel-Chat\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "register-chat" || args[0] === "registerchat") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`Register-Chat\` kanalı ${channel} olarak ayarlandı!`)}
    if(args[0] === "invite-log" || args[0] === "invitelog") {
        ...
        message.reply(`${client.emojis.cache.find(x => x.name === "green")} \`İnvite-Log\` kanalı ${channel} olarak ayarlandı!`)}
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------
